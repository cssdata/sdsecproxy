...
NOTE: If you don't link-in your backend, BACKEND may point to an external backend also. In this case here, backend and proxy share the same docker network.
